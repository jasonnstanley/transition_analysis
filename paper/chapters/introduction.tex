...
model development, independent verification, interpretation, and publication-ready reporting within a single reproducible pipeline. The overall research workflow is described in \S\ref{sec:workflow}.
