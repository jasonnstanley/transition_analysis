...
Data Preparation $\rightarrow$ Statistical Analysis $\rightarrow$
Machine Learning $\rightarrow$ Independent Verification (R)
$\rightarrow$ Automated Reporting
}}
\caption{Overview of the reproducible analytical workflow used in this study.}
\label{fig:workflow}
\end{figure}
